...
(() => {
  ...
  const stylesheet =
    ...
    // touch-action:none is only needed while actively panning/resizing in
    // reframe mode — scoped to [data-reframe] so a plain filled slot never
    // blocks the page's native touch-scroll (was unconditional before and
    // made every photo a dead zone for scrolling on mobile).
